...
<!--
  ...
  Handle assignment to nextState guarded by switch statements 
  ...
  <xsl:template
    match="
      *[
        ...
        and 2=count(ancestor::block_items[@class='Case'])
      ]
    ">

    <xsl:variable name="EventType" select="../expr[@class='ID']/@name" />
